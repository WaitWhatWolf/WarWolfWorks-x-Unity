...
namespace WarWolfWorks.EditorBase.Services
{
    internal sealed class AdvancedDebugService : IService
    {
        ...
        {
            Settings.SaveDebugColor(Debugging.MessageType.Info, LogColor);
            Settings.SaveDebugColor(Debugging.MessageType.Warning, WarningColor);
            Settings.SaveDebugColor(Debugging.MessageType.Error, ErrorColor);
