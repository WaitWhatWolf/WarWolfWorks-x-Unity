...
namespace WarWolfWorks.NyuEntities.Itemization
{
    ...
    public abstract class NyuInventory<T> : NyuComponent, IInventory<T>, INyuPreAwake where T : NyuItem
	{
        ...
        /// </summary>
        public int FirstEmptyIndex() => ns_Items.GetNullIndex();
        /// <summary>
        /// Gets the first slot index that doesn't contain an item starting from specified index.
        /// </summary>
        /// <param name="from"></param>
        /// <returns></returns>
        public int FirstEmptyIndex(int from) => ns_Items.GetNullIndex(from);
        /// <summary>
        ...
        /// <returns></returns>
        public int FirstEmptyIndex(int from, int count) => ns_Items.GetNullIndex(from, count);
        /// <summary>
        /// Gets the first slot index that within given range.
        /// </summary>
        /// <param name="range"></param>
        /// <returns></returns>
        public int FirstEmptyIndex(IntRange range) => ns_Items.GetNullIndex(range);
        /// <summary>
        ...
        public bool AddItem(T item)
        {
            ...
            int emptyIndex = ns_Items.GetNullIndex();
            if (emptyIndex == -1)
                return false;
