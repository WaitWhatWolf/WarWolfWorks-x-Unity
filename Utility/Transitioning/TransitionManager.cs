...
namespace WarWolfWorks.Utility.Transitioning
{
    ...
    public sealed class TransitionManager : Menu
    {
        ...
        public void RunTransition(int ofIndex)
        {
            ...
            this.StartCoroutine(ITransition(), ref ITransitionIsRunning);
        }
        ...
        private IEnumerator ITransition()
        {
            ...
            AdvancedDebug.LogFormat("Starting Transition {0}...", AdvancedDebug.DEBUG_LAYER_WWW_INDEX, indexUsed);
            ...
            AdvancedDebug.LogFormat("Completing Transition {0}...", AdvancedDebug.DEBUG_LAYER_WWW_INDEX, indexUsed);
            ...
            AdvancedDebug.LogFormat("Ending Transition {0}...", AdvancedDebug.DEBUG_LAYER_WWW_INDEX, indexUsed);
            ...
            AdvancedDebug.LogFormat("Ending Transition {0} coroutine...", AdvancedDebug.DEBUG_LAYER_WWW_INDEX, indexUsed);
            this.StopCoroutine(ITransition(), ref ITransitionIsRunning);
        }
