...
namespace WarWolfWorks.IO.CTS
{
    ...
    public sealed class Catalog
    {
        ...
        private void ThrowOnInvalidPath(string path) //Used at the start of constructors.
        {
            if (!Enumerable.Contains(path, '.'))
                throw new ArgumentException("The path given is invalid. " +
                    "Make sure to add the name of the file at the end of the path as well as making sure that the file contains an extension.");
        }
